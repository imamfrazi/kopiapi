...
function glitche_register_portfolio() {
...
add_action( 'init', 'glitche_register_portfolio' );

function glitche_register_portfolio_categories() {
...
add_action( 'init', 'glitche_register_portfolio_categories' );
