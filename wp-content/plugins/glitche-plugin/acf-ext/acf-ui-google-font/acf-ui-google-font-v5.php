...
if( ! class_exists( 'acf_field_glitche_ui_google_font' ) ) :

class acf_field_glitche_ui_google_font extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->label = __( 'Google Font', 'glitche-plugin' );
...
// initialize
new acf_field_glitche_ui_google_font();
