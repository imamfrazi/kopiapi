...
if( ! class_exists( 'acf_field_glitche_cf7' ) ) :

class acf_field_glitche_cf7 extends acf_field {
	...
	*/
	...
	function __construct() {
		...
		*/
		...
		$this->label = __( 'Contact Form 7', 'glitche-plugin' );
		...
		*/
		...
		$this->l10n = array(
			'error'	=> __( 'Error! Please enter a higher value', 'glitche-plugin' ),
		);
	...
	function render_field_settings( $field ) {
		...
		*/
		...
		acf_render_field_setting( $field, array(
			'label'			=> __( 'Allow Null?', 'glitche-plugin' ),
			'type'			=> 'radio',
			'name'			=> 'allow_null',
			'choices' =>  array(
			  	1 =>  __( 'Yes', 'glitche-plugin' ),
			  	0 =>  __( 'No', 'glitche-plugin' ),
			),
			'layout'  =>  'horizontal'
		));

		acf_render_field_setting( $field, array(
			'label'			=> __( 'Select Multiple?', 'glitche-plugin' ),
			'type'			=> 'radio',
			'name'			=> 'multiple',
			'choices' =>  array(
				1 =>  __( 'Yes', 'glitche-plugin' ),
		...
		acf_render_field_setting( $field, array(
			'label'			=> __( 'Disable Forms?', 'glitche-plugin' ),
			'instructions'	=> __( 'User will not be able to select these forms', 'glitche-plugin' ),
			'type'			=> 'select',
			'name'			=> 'disable',
			'multiple'		=> '1',
			'allow_null'  =>  '0',
